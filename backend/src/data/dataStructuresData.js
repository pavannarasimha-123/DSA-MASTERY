export const DATA_STRUCTURES = [
    ...
    "operationsTable": [
      {
        ...
        "complexity": "O(1)",
        "note": "Direct memory pointer arithmetic"
      },
      {
      ...
      },
      {
        ...
        "complexity": "O(n)",
        "note": "Shifts all existing elements to the right"
      },
      {
        "operation": "Insert at end",
        "complexity": "O(1)*",
        "note": "Amortized constant time for dynamic array"
      },
      {
        "operation": "Delete from beginning",
        "complexity": "O(n)",
        "note": "Shifts all elements left by 1 position"
      },
      {
  ...
  },
  {
    ...
    "operationsTable": [
      ...
      {
        "operation": "Substrings",
        "complexity": "O(k)",
        "note": "Copies k characters into new string"
      },
      {
        "operation": "Concatenation in loop (+)",
        "complexity": "O(n²)",
        "note": "Repeated string allocations"
      },
      {
        "operation": "StringBuilder.append()",
        "complexity": "O(1)*",
        "note": "Amortized append to internal buffer"
      }
    ],
    "javaComparison": {
    ...
    "operationsTable": [
      {
        ...
        "complexity": "O(1)",
        "note": "newHead.next = head"
      },
      {
        "operation": "Insert at Tail (with tail ref)",
        "complexity": "O(1)",
        "note": "tail.next = newNode"
      },
      {
      ...
      },
      {
        "operation": "Access by Index",
        "complexity": "O(n)",
        "note": "No random access pointer arithmetic"
      }
    ],
    "javaComparison": {
    ...
    "operationsTable": [
      {
        ...
        "complexity": "O(log n)",
        "note": "Halves search space each branch"
      },
      {
        "operation": "Search (Degenerate BST)",
        "complexity": "O(n)",
        "note": "Degenerates into a linked list"
      },
      {
        "operation": "Insert / Delete (Balanced)",
        "complexity": "O(log n)",
        "note": "Tree rebalancing (AVL/Red-Black)"
      },
      {
        "operation": "Tree Traversals (In/Pre/Post)",
        "complexity": "O(n)",
        "note": "Visits every node once"
      }
    ],
    "javaComparison": {
    ...
    "operationsTable": [
      {
        ...
        "complexity": "O(log n)",
        "note": "Bubble up / sift up"
      },
      {
        "operation": "Extract Min/Max (poll)",
        "complexity": "O(log n)",
        "note": "Replace root with last leaf, sift down"
      },
      {
        "operation": "Peek Root",
        "complexity": "O(1)",
        "note": "Direct access to index 0"
      },
      {
        "operation": "Heapify array",
        "complexity": "O(n)",
        "note": "Bottom-up buildHeap algorithm"
      }
    ],
    "javaComparison": {
    ...
    "operationsTable": [
      {
        ...
        "complexity": "O(V + E)",
        "note": "Visits every node and edge once"
      },
      {
        "operation": "Dijkstra (Shortest Path)",
        "complexity": "O((V + E) log V)",
        "note": "Non-negative edge weights using Min-Heap"
      },
      {
        "operation": "Bellman-Ford",
        "complexity": "O(V * E)",
        "note": "Handles negative edge weights"
      },
      {
        "operation": "Kruskal / Prim (MST)",
    ...
    "operationsTable": [
      {
        ...
        "note": "Stable, Not in-place (O(n) space)"
      },
      {
        "operation": "Quick Sort",
        "complexity": "O(n log n) avg / O(n²) worst",
        "note": "Unstable, In-place (O(log n) stack)"
      },
      {
        "operation": "Heap Sort",
        "complexity": "O(n log n)",
        "note": "Unstable, In-place (O(1) space)"
      },
      {
        "operation": "Counting Sort",
        "complexity": "O(n + k)",
        "note": "Stable, Non-comparison for small integer ranges"
      },
      {
        "operation": "Insertion Sort",
        "complexity": "O(n) best / O(n²) worst",
        "note": "Stable, In-place, fast on nearly sorted data"
      }
    ],
    "javaComparison": {
